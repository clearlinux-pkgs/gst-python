...
Source0  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.9.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.9.tar.xz.asc
...
%setup -q -n gst-python-1.24.9
cd %{_builddir}/gst-python-1.24.9
pushd ..
cp -a gst-python-1.24.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730387776
