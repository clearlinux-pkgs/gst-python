...
%prep
%setup -q -n gst-python-1.20.1
cd %{_builddir}/gst-python-1.20.1
...
cp %{_builddir}/gst-python-1.20.1/COPYING %{buildroot}/usr/share/package-licenses/gst-python/a38bf62fc86fcde6fe8b09b6a8732d3c24edfd95
