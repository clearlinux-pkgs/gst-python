...
Source0  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.11.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.11.tar.xz.asc
...
%setup -q -n gst-python-1.24.11
cd %{_builddir}/gst-python-1.24.11
pushd ..
cp -a gst-python-1.24.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736270401
