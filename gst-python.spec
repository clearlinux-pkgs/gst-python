...
Source0  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.7.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.7.tar.xz.asc
...
%setup -q -n gst-python-1.24.7
cd %{_builddir}/gst-python-1.24.7
pushd ..
cp -a gst-python-1.24.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724252011
