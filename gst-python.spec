...
Version  : 1.22.9
Release  : 33
URL      : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.22.9.tar.xz
Source0  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.22.9.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.22.9.tar.xz.asc
...
%prep
%setup -q -n gst-python-1.22.9
cd %{_builddir}/gst-python-1.22.9
pushd ..
cp -a gst-python-1.22.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706197988
