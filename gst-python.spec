...
Source0  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.22.10.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.22.10.tar.xz.asc
...
%prep
%setup -q -n gst-python-1.22.10
cd %{_builddir}/gst-python-1.22.10
pushd ..
cp -a gst-python-1.22.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707849925
