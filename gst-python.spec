...
Version  : 1.26.3
Release  : 49
URL      : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.26.3.tar.xz
Source0  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.26.3.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.26.3.tar.xz.asc
...
%setup -q -n gst-python-1.26.3
cd %{_builddir}/gst-python-1.26.3
pushd ..
cp -a gst-python-1.26.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751043195
