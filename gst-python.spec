...
Source0  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.8.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.8.tar.xz.asc
...
%setup -q -n gst-python-1.24.8
cd %{_builddir}/gst-python-1.24.8
pushd ..
cp -a gst-python-1.24.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730329209
