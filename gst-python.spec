...
Version  : 1.24.0
Release  : 35
URL      : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.0.tar.xz
Source0  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.0.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.0.tar.xz.asc
...
%prep
%setup -q -n gst-python-1.24.0
cd %{_builddir}/gst-python-1.24.0
pushd ..
cp -a gst-python-1.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709660954
