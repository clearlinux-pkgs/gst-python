...
Version  : 1.24.2
Release  : 37
URL      : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.2.tar.xz
Source0  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.2.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-python/gst-python-1.24.2.tar.xz.asc
...
%prep
%setup -q -n gst-python-1.24.2
cd %{_builddir}/gst-python-1.24.2
pushd ..
cp -a gst-python-1.24.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712761850
